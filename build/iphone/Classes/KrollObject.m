...
//@interface selbiAppObject : NSObject
//@end

@interface selbiAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[selbiAppObject class]])
		{
			for (NSString *key in [[(selbiAppObject*)o modules] allKeys])
			{
