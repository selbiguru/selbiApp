...
// in simulator we redefine to format for selbiApp Developer console
...
{\
	NSString * exceptionName = [@"org.selbiapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.selbiapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIselbiAppNativeItemNone = -1, 
	UIselbiAppNativeItemSpinner = -2,
	UIselbiAppNativeItemProgressBar = -3,
	
	UIselbiAppNativeItemSlider = -4,
	UIselbiAppNativeItemSwitch = -5,
	UIselbiAppNativeItemMultiButton = -6,
	UIselbiAppNativeItemSegmented = -7,
	
	UIselbiAppNativeItemTextView = -8,
	UIselbiAppNativeItemTextField = -9,
	UIselbiAppNativeItemSearchBar = -10,
	
	UIselbiAppNativeItemPicker = -11,
	UIselbiAppNativeItemDatePicker = -12,
	
	UIselbiAppNativeItemInfoLight = -13,
	UIselbiAppNativeItemInfoDark = -14,
	
	UIselbiAppNativeItemDisclosure = -15,
	
	UIselbiAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all selbiApp instances of
